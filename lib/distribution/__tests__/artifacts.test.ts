...
describe("distribution artifacts", () => {
  it("creates provider-independent HTML and text email", () => {
    const article: Article = { slug: "2026-07-21-test", lang: "cs", fallback: false, mdx: "Body", frontmatter: { title: "<Title>", slug: "2026-07-21-test", date: "2026-07-21", dek: "Summary", tags: [], sources: [], illustration: { prompt: "", alt: "" }, type: "weekly" } };
