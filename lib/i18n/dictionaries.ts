...
const en = {
  ...
  sections: {
    ...
    discoverPreviousWeek: "Discover the previous week",
    archiveExhausted: "The archive does not reach further back.",
    archiveExhaustedLink: "Older editions are in the Archive",
    modelsTitle: "Editions about models.",
    modelsEmpty: "No edition focused on models yet.",
    modelsEmptyBody: "The section fills up as new editions come out.",
    talkedTitle: "What people discuss.",
    talkedIntro: "Posts worth reading from outside the magazine.",
    talkedEmpty: "Nothing new today.",
    podcastsTitle: "Episodes worth hearing.",
    podcastsEmpty: "No new episode today.",
    eventsTitle: "Where to go.",
    eventsCz: "Czechia",
    eventsWorld: "World",
    eventsPast: "Past",
    eventsScope: "Event range",
  ...
  about: {
    ...
    sourcesBody: "Primary sources take precedence for claims about releases and regulation. Independent reporting supplies verification and context. Every edition ends with the sources it relied on.",
    editorialTitle: "Editorial rules",
    editorialBody: "Verified fact, company claim, analysis and open question stay visibly separate. The magazine does not claim completeness and does not reach for superlatives where a description will do.",
    correctionsTitle: "Corrections",
    correctionsBody: "A factual error is corrected on the affected edition and recorded in the public corrections index.",
  ...
  pulse: {
    ...
    intro:
      "Model pricing and intelligence, provider service status, and package momentum, refreshed daily.",
    ...
    empty: "No pulse data yet. It lands with the next update.",
  },
  glossary: {
    kicker: "glossary",
...
const cs: Dict = {
  ...
  sections: {
    ...
    discoverPreviousWeek: "Objevit předchozí týden",
    archiveExhausted: "Dál už archiv nesahá.",
    archiveExhaustedLink: "Starší vydání najdete v Archivu",
    modelsTitle: "Vydání o modelech.",
    modelsEmpty: "Zatím tu není žádné vydání zaměřené na modely.",
    modelsEmptyBody: "Kategorie se plní postupně, jak vycházejí nová vydání.",
    talkedTitle: "O čem se mluví.",
    talkedIntro: "Texty odjinud, které stojí za přečtení.",
    talkedEmpty: "Dnes zatím nic nového.",
    podcastsTitle: "Epizody, které stojí za poslech.",
    podcastsEmpty: "Dnes nevyšla žádná nová epizoda.",
    eventsTitle: "Kam jít.",
    eventsCz: "Česko",
    eventsWorld: "Svět",
    eventsPast: "Proběhlé",
    eventsScope: "Rozsah akcí",
    eventsEmpty: "Zatím tu nejsou žádné nadcházející akce.",
    eventsFree: "zdarma",
    eventsOnline: "online",
  ...
  about: {
    ...
    sourcesBody: "U tvrzení o vydáních a regulaci má přednost primární zdroj. Nezávislé zpravodajství slouží k ověření a kontextu. Každé vydání končí přehledem zdrojů, ze kterých vychází.",
    editorialTitle: "Redakční pravidla",
    editorialBody: "Ověřený fakt, tvrzení firmy, analýza a otevřená otázka jsou v textu oddělené. Magazín si nenárokuje úplnost a nesahá po superlativech tam, kde stačí popis.",
    correctionsTitle: "Opravy",
    correctionsBody: "Věcnou chybu opravíme přímo u dotčeného vydání a zapíšeme ji do veřejného přehledu oprav.",
  ...
  pulse: {
    ...
    intro:
      "Ceny a inteligence modelů, stav služeb poskytovatelů a dynamika balíčků. Obnovuje se každý den.",
    ...
    updated: "ceny k",
    source: "Data: TensorFeed + npm registry",
    empty: "Zatím žádná data. Objeví se s další aktualizací.",
  },
  glossary: {
    kicker: "slovník",
