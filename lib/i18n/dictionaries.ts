...
const en = {
  ...
  common: {
    ...
    weekly: "weekly",
    atomFeed: "atom feed",
    transmissionOngoing: "transmission · ongoing",
  },
  home: {
    emptyKicker: "issue 000",
    emptyTitle: "The first transmission is being written.",
  ...
  stats: {
    kicker: "telemetry",
    title: "Stats from the broadcast log.",
  ...
  notFound: {
    ...
    title: "This transmission was never broadcast.",
  ...
  error: {
    kicker: "fault · transmission interrupted",
    title: "Something went wrong.",
    body: "An unexpected error knocked this page off the air. Try again, or head back to the latest issue.",
    retry: "try again",
    home: "back home",
  },
};
...
const cs: Dict = {
  ...
  common: {
    ...
    weekly: "týdenní",
    atomFeed: "atom kanál",
    transmissionOngoing: "vysílání · probíhá",
  },
  home: {
    emptyKicker: "vydání 000",
    emptyTitle: "První přenos se právě připravuje.",
  ...
  footer: {
    description:
      "Denní magazín o AI a technologiích, který edituje jazykový model. Články vznikají každé ráno z pečlivě vybraných primárních zdrojů, nezávislých analytiků a drátu.",
  },
  archive: {
    kicker: "archiv",
    title: "Každé vydání.",
  ...
  stats: {
    kicker: "telemetrie",
    title: "Statistiky z vysílacího deníku.",
  ...
  search: {
    ...
    noMatch: "žádný přenos neodpovídá.",
    placeholder: "titulek, perex, téma, slug…",
    open: "hledat",
  },
  health: {
    kicker: "stav · stav pipeline",
    title: "Žije magazín?",
    intro:
  ...
  notFound: {
    kicker: "404 · signál ztracen",
    title: "Tento přenos nebyl nikdy odvysílán.",
    body: "Stránka, kterou hledáte, tu není. Možná to bylo budoucí vydání, které ještě nevyšlo.",
    home: "zpět na nejnovější vydání",
  },
  error: {
    kicker: "porucha · přenos přerušen",
    title: "Něco se pokazilo.",
    body: "Neočekávaná chyba shodila tuto stránku z vysílání. Zkuste to znovu, nebo se vraťte na nejnovější vydání.",
    retry: "zkusit znovu",
    home: "zpět domů",
  },
};
