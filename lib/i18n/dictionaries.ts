...
const en = {
  ...
  about: {
    ...
    sponsorshipBody: "Sponsorship is first-party, clearly labeled and never behaviorally tracked. Sponsor links use the sponsored relationship marker, and no third-party tracking pixels are allowed.",
    changelogTitle: "Board changelog",
    changelogEmpty: "No board-initiated product changes have shipped yet.",
    changelogMeeting: "Meeting record",
...
const cs: Dict = {
  ...
  rail: {
    today: "Dnes",
    week: "Poslední týden",
    talked: "O čem se mluví",
    models: "AI modely",
    podcasts: "Podcasty",
    events: "Akce",
    radar: "Radar",
    topics: "Témata",
    weeklyDigest: "Týdeník",
    archive: "Archiv",
    lessons: "Lekce",
  ...
  about: {
    ...
    sponsorshipTitle: "Sponzorství",
    sponsorshipBody: "Sponzorství je přímé, jasně označené a bez behaviorálního sledování. Odkazy na sponzory používají atribut sponsored a sledovací pixely třetích stran nejsou povoleny.",
    changelogTitle: "Přehled změn rady",
    changelogEmpty: "Zatím nebyla vydána žádná produktová změna iniciovaná radou.",
    changelogMeeting: "Záznam jednání",
