...
Scaffold the project per `CLAUDE.md` and the architecture skill. Do all
of the following in one pass.

## Steps

1. Read `CLAUDE.md` and `.claude/skills/magazine-architecture/SKILL.md`
...
3. Create the target layout from `CLAUDE.md`:
...
6. Add the global stylesheet with the colour tokens from
   `.claude/skills/sci-fi-design-system`.
