...
```
media/preview.webm        →  nxt-portfolio/public/previews/aifirst/preview.webm
media/preview.mp4         →  nxt-portfolio/public/previews/aifirst/preview.mp4
media/preview-poster.png  →  nxt-portfolio/public/previews/aifirst/preview-poster.png
```
