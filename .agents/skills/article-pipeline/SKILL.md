...
description: How the daily curate -> write -> illustrate pipeline uses the Codex API, including prompt structure, caching, and the MDX frontmatter contract. Use when modifying lib/pipeline/* or the prompts.
---
