---
name: "source-command-preview-magazine"
description: "Start the Next.js dev server in the background and report the URL."
---

# source-command-preview-magazine

Use this skill when the user asks to run the migrated source command `preview-magazine`.
