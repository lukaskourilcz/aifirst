...
Two slots exist: `today-partner-belt`, after the completion mark on Today, at the
IAB standard 728×90 and 320×100, and the 300×250 `rail-square`. Since 2026-09-25
both carry the owner's own devShark creatives, labelled as a house project, so
neither earns anything yet. Filling one with a paying partner means committing a
local image and a destination — no ad network, no script, no tracking, so it
stays inside the CSP and costs nothing to serve. That is the
